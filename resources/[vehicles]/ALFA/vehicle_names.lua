...
Citizen.CreateThread(function()
	--Liveries
	AddTextEntry("gtr_LIV1", "ALFA 1.0")
	AddTextEntry("gtr_LIV2", "ALFA 2.0")
	AddTextEntry("gtr_LIV3", "ALFA PLAIN")
	AddTextEntry("gtr_LIV4", "Yin & Yang")
	AddTextEntry("gtr_LIV5", "Fast n Furious")
	AddTextEntry("gtr_LIV6", "Oil Spill")
	AddTextEntry("gtr_LIV7", "Liberty Performance")
	AddTextEntry("gtr_LIV8", "Inital D")
	AddTextEntry("gtr_LIV9", "Cherry Blossoms")
	AddTextEntry("gtr_LIV10", "Godzilla")
	--Cosmetics
	AddTextEntry("gtr_bumf_1", "")
	AddTextEntry("gtr_LIV", "")
	AddTextEntry("gtr_LIV", "")
	AddTextEntry("gtr_LIV", "")
	-- Generic Spoiler
