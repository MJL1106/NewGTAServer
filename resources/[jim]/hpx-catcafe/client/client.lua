...
CreateThread(function()
	...
	--Stashes
	exports['qb-target']:AddBoxZone("CatPrepared", vector3(-587.4, -1059.6, 21.20), 2.0, 2.5, { name="CatPrepared", heading = 270.0, debugPoly=Config.Debug, minZ=21.45, maxZ=23.45 }, 
		{ options = { {  event = "hpx-catcafe:Stash", icon = "fas fa-box-open", label = "Prepared Food", stash = "Shelf" }, },  distance = 2.0 })
	--FRIDGE
	exports['qb-target']:AddBoxZone("CatFridge", vector3(-588.06, -1067.1, 21.20), 3.5, 0.5, { name="CatFridge", heading = 0, debugPoly=Config.Debug, minZ=19.84, maxZ=23.84 }, 
		{ options = { {  event = "hpx-catcafe:Stash", icon = "fas fa-temperature-low", label = "Big Storage", stash = "Fridge", job = "catcafe" }, }, distance = 1.0 })		
	exports['qb-target']:AddBoxZone("CatFridge2", vector3(-590.67, -1068.1, 21.20), 2.0, 0.6, { name="CatFridge2", heading = 0, debugPoly=Config.Debug, minZ=19.84, maxZ=23.84 }, 
		{ options = { {  event = "hpx-catcafe:Stash", icon = "fas fa-temperature-low", label = "Small Storage", stash = "Fridge2", job = "catcafe"  }, }, distance = 1.0 })
	--WARESTORAGE
	exports['qb-target']:AddBoxZone("CatStorage", vector3(-598.0, -1068.47, 21.20), 4.0, 1.5, { name="CatStorage", heading = 90, debugPoly=Config.Debug, minZ=20.94, maxZ=24.94 }, 
		{ options = { {  event = "hpx-catcafe:Shop", icon = "fas fa-box-open", label = "Open Store", job = "catcafe" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatStorage2", vector3(-598.25, -1065.61, 21.20), 4.0, 1.5, { name="CatStorage2", heading = 90, debugPoly=Config.Debug, minZ=20.94, maxZ=24.94 }, 
		{ options = { {  event = "hpx-catcafe:Shop", icon = "fas fa-box-open", label = "Open Store", job = "catcafe" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatStorage3", vector3(-598.31, -1062.79, 21.20), 4.0, 1.5, { name="CatStorage3", heading = 90, debugPoly=Config.Debug, minZ=20.94, maxZ=24.94 }, 
		{ options = { {  event = "hpx-catcafe:Shop", icon = "fas fa-box-open", label = "Open Store", job = "catcafe" }, }, distance = 2.0 })
	--Sinks
	exports['qb-target']:AddBoxZone("CatWash1", vector3(-587.89, -1062.58, 21.20), 0.7, 0.7, { name="CatWash1", heading = 0, debugPoly=Config.Debug, minZ=19.11, maxZ=23.11 }, 
		{ options = { { event = "hpx-catcafe:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands" }, }, distance = 1.5	})		
	exports['qb-target']:AddBoxZone("CatWash2", vector3(-570.23, -1051.41, 21.20), 0.5, 0.5, { name="CatWash2", heading = 0, debugPoly=Config.Debug, minZ=21.74, maxZ=22.94, }, 
		{ options = { { event = "hpx-catcafe:washHands", icon = "fas fa-hand-holding-water", label = "Wash Your Hands" }, }, distance = 1.2	})		
	exports['qb-target']:AddBoxZone("CatWash3", vector3(-570.25, -1056.98, 21.20), 0.5, 0.5, { name="CatWash3", heading = 0, debugPoly=Config.Debug, minZ=21.74, maxZ=22.94, },
		{ options = { { event = "hpx-catcafe:washHands", icon = "fas fa-hand-holding-water", label = "إWash Your Hands" }, }, distance = 1.2 })
	--Oven
	...
	--Hob
	exports['qb-target']:AddBoxZone("CatHob", vector3(-591.02, -1056.56, 21.20), 1.5, 0.6, { name="CatHob", heading = 0, debugPoly=Config.Debug, minZ = 19.84, maxZ = 23.84, }, 
	...
	exports['qb-target']:AddBoxZone("CatReceipt1", vector3(-584.07, -1058.69, 22.34), 0.5, 0.5, { name="CatReceipt1", heading = 0, debugPoly=Config.Debug, minZ = 19.04, maxZ = 23.04, }, 
		{ options = { { event = "hpx-catcafe:bill", icon = "fas fa-credit-card", label = "Charge Customer", job = "catcafe",
	...
	--Chopping Board
	exports['qb-target']:AddBoxZone("CatBoard", vector3(-590.94, -1063.16, 20.20), 1.5, 0.6, { name="CatBoard", heading = 0, debugPoly=Config.Debug, minZ=18.96, maxZ=22.96, }, 
		{ options = { { event = "hpx-catcafe:Menu:ChoppingBoard", icon = "fas fa-utensils", label = "Sandwiches", job = "catcafe" }, }, distance = 2.0 })	
	--Tables
	exports['qb-target']:AddBoxZone("CatTable", vector3(-573.43, -1059.76, 21.49), 1.9, 1.0, { name="CatTable", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "hpx-catcafe:Stash", icon = "fas fa-box-open", label = "CatTable", stash = "Table_1" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatTable2", vector3(-573.44, -1063.45, 21.49), 1.9, 1.0, { name="CatTable2", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "hpx-catcafe:Stash", icon = "fas fa-box-open", label = "CatTable2", stash = "Table_2" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatTable3", vector3(-573.41, -1067.09, 21.49), 1.9, 1.0, { name="CatTable3", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "hpx-catcafe:Stash", icon = "fas fa-box-open", label = "CatTable3", stash = "Table_3" }, }, distance = 2.0 })
	exports['qb-target']:AddBoxZone("CatTable4", vector3(-578.68, -1051.09, 21.49), 1.2, 0.9, { name="CatTable4", heading = 91.0, debugPoly=Config.Debug, minZ=21.49, maxZ=22.89 }, 
		{ options = { {  event = "hpx-catcafe:Stash", icon = "fas fa-box-open", label = "CatTable4", stash = "Table_4" }, }, distance = 2.0 })	
	--Clockin
	exports['qb-target']:AddBoxZone("CatClockin", vector3(-594.34, -1053.35, 22.34), 3.5, 0.5, { name="CatClockin", heading = 0, debugPoly=Config.Debug, minZ=22.19, maxZ=23.79 }, 
		{ options = { { type = "server", event = "QBCore:ToggleDuty", icon = "fas fa-user-check", label = "Toggle Duty", job = "catcafe" },
					  { event = "qb-bossmenu:client:OpenMenu", icon = "fas fa-clipboard-check", label = "bossmenu", job = bossroles, }, 
					}, distance = 2.0 })
end)
        ...
        for k, v in pairs(data.craftable[data.tablenumber]) do
            ...
            QBCore.Functions.TriggerCallback('hpx-catcafe:get', function(amount)
                ...
                elseif not amount then
                    ...
                    TriggerEvent("hpx-catcafe:FoodProgress", data)
                end
...
RegisterNetEvent('hpx-catcafe:FoodProgress', function(data)
    ...
    QBCore.Functions.Progressbar(
        'making food...',
        data.bartext .. QBCore.Shared.Items[data.item].label,
        data.time,
        false,
        false,
        ...
        function()
            TriggerEvent('inventory:client:busy:status', false)
            TriggerEvent('QBCore:Notify', "إلغاء!", 'error')
        end
    )
end)
...
RegisterNetEvent('hpx-catcafe:Menu:ChoppingBoard', function()
	...
	local ChopMenu = {}
	ChopMenu[#ChopMenu + 1] = { header = "Sandwiches", txt = "", isMenuHeader = true }
...
RegisterNetEvent('hpx-catcafe:Menu:Oven', function()
	if not jobCheck() then return end
	local OvenMenu = {}
	OvenMenu[#OvenMenu + 1] = { header = "Oven", txt = "", isMenuHeader = true }
...
RegisterNetEvent('hpx-catcafe:Menu:Coffee', function()
	if not jobCheck() then return end
	local CoffeeMenu = {}
	CoffeeMenu[#CoffeeMenu + 1] = { header = "Pour Coffee", txt = "", isMenuHeader = true }
...
RegisterNetEvent('hpx-catcafe:Menu:Hob', function()
	if not jobCheck() then return end
	local HobMenu = {}
	HobMenu[#HobMenu + 1] = { header = "Hob", txt = "", isMenuHeader = true }
...
RegisterNetEvent('hpx-catcafe:client:DrinkAlcohol', function(itemName)
    ...
    QBCore.Functions.Progressbar("Drink", "He drinks "..QBCore.Shared.Items[itemName].label.."..", math.random(3000, 6000), false, true, {
...
RegisterNetEvent('hpx-catcafe:client:Drink', function(itemName)
	...
	QBCore.Functions.Progressbar("drinks", "drinks "..QBCore.Shared.Items[itemName].label.."..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('hpx-catcafe:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", "Eat "..QBCore.Shared.Items[itemName].label.."..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent("hpx-catcafe:bill", function()
	...
	if bill then
	    ...
	    TriggerServerEvent("hpx-catcafe:bill:player", bill.id, bill.amount)
	end
      end)
