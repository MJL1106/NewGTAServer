...
if not Config.JimConsumables then
	...
	local foodTable = {
		["bscoffee"] = { emote = "bscoffee", canRun = false, time = math.random(5000, 6000), stress = 25, heal = 0, armor = 0, type = "drink", stats = { thirst = math.random(20,25), }},
		["bscoke"] = { emote = "bscoke", canRun = false, time = math.random(5000, 6000), stress = 15, heal = 0, armor = 0, type = "drink", stats = { thirst = math.random(30,35), }},
		["heartstopper"] = { emote = "burger", canRun = false, 	time = math.random(5000, 6000), stress = 35, heal = 25, armor = 0, type = "food", stats = { hunger = math.random(20,25), }},
		["torpedo"] = {	emote = "torpedo", canRun = false, time = math.random(5000, 6000), stress = 0, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(30,35), }},
		["shotfries"] = { emote = "bsfries", canRun = false, time = math.random(5000, 6000), stress = 15, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(25,30), }},
		["meatfree"] = { emote = "burger", canRun = false, time = math.random(5000, 6000), stress = 0, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(15,20), }},
		["shotnuggets"] = {	emote = "bsfries", canRun = false, time = math.random(5000, 6000), stress = 10, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(25,30), }},
		["shotrings"] = { emote = "bsfries", canRun = false, time = math.random(5000, 6000), stress = 10, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(25,30), }},
		["moneyshot"] = { emote = "burger", canRun = false, time = math.random(5000, 6000), stress = 15, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(30,35), }},
		["bleeder"] = {	emote = "burger", canRun = false, time = math.random(5000, 6000), stress = 15, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(35,40), }},
		["rimjob"] = { emote = "donut", canRun = false, time = math.random(5000, 6000), stress = 15, heal = 0, armor = 15, type = "food", stats = { hunger = math.random(35,40), }},
		["creampie"] = { emote = "donut", canRun = false, time = math.random(5000, 6000), stress = 25, heal = 0, armor = 20, type = "food", stats = { hunger = math.random(35,40), }},
		["cheesewrap"] = { emote = "sandwich", canRun = false, 	time = math.random(5000, 6000), stress = 0, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(25,30), }},
		["chickenwrap"] = {	emote = "sandwich", canRun = false, time = math.random(5000, 6000), stress = 0, heal = 0, armor = 0, type = "food", stats = { hunger = math.random(25,30), }},
	}
	local emoteTable = {
...
QBCore.Functions.CreateUseableItem("murderbag", function(source, item) TriggerClientEvent('jim-burgershot:MurderBagStash', source, {}, item.info["id"], true) end)
