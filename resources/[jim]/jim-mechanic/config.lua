...
-- Discord preview receipts
	...
	DiscordDefault = "https://discord.com/api/webhooks/1181171063464402985/i41PD_Ho-1bbqHXP0Ua7I9Msvz9MHFiKKbcMMwlggQYLEwOOrabgMZ7GQOkU7Uop_eBm", -- Set this to the default channel API link if one isn't set for a location
