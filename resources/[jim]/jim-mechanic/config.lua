Config = {
	...
	Main = { -- Main variables
		...
		JobRoles = { "mechanic", "tuners", "lsc" }, -- These are the job roles who can use items if RequiresJob is enabled.
									-- Add your extra job roles here or just leave as "mechanic"
									-- Example-- --JobRoles = { "mechanic", "tuner" }
	},

	Overrides = {
		CosmeticItemRemoval = false, -- If "true" items will be removed on successful application of a mod
