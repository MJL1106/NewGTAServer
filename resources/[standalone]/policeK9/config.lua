...
Config.JobRank = 4									-- If Config.JobRestriction = true, then sets what minimum rank a police officer must be to pull out a K9
...
Config.Framework = "qb" -- Select Your Framework ( esx or qb)
Config.Lenguage = "en"  -- Select lenguage 
Config.KeyToAttachGps = "HOME" -- You can change the key here, if you need more info about it see https://docs.fivem.net/docs/game-references/controls/
Config.WhitelistedJobs = {"police"} -- jobs that can use the tracker
Config.UseItem = true  -- If you want to use an item to place the tracker, you need to set it to true
Config.ItemName = "cartracker" -- Name of the item you will use
Config.Debug = true
Config.Target = 'qb'
Config.Bikes = { 
	"bmx", 
...
function Notifications(text, types, time)  -- Simple notification, you can change this if you use custom notification
...
Config.Translations = {
    ["it"] = {
        ["installed"] = "Gps Installato",
        ["gps_connected"] = "Connessione Gps Stabilita",
        ["interrupted"] = "Connessione Gps Interrotta",
        ["signal_lost"] = "Segnale Perso",
        ["gps_off"] = "Il segnalatore GPS è Spento",
        ["no_item"] = "Non hai il Gps con te"
    },
    ["en"] = {
        ["installed"] = "Gps installed",
        ["gps_connected"] = "GPS connection established",
        ["interrupted"] = "GPS connection interrupted",
        ["signal_lost"] = "Signal Lost",
        ["gps_off"] = "The GPS Tracker is Off",
        ["no_item"] = "You don't have GPS with you"
    }
