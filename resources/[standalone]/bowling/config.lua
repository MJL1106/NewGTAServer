...
Strings = {
    ['press_start'] = 'Press ~INPUT_PICKUP~ to get bowlingball',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Select your track\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Choose\n~INPUT_FRONTEND_RRIGHT~ Exit',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Rotate person\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Change force\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Change View of Cam\n~INPUT_ATTACK~ Throw\n~INPUT_FRONTEND_RRIGHT~ Stop the game',
    ['force'] = 'Your Force: %s',
    ['strike'] = {'WOW! ATTRACTIVE! ',' STRIKE !!'},
    ['spare'] = {'Bowling', 'I played well! Unfortunately nothing.'},
    ['x_pinsdown'] = {'Bowling', 'You dropped %s pins out of %s'},
    ['this_occupied'] = 'This bowling track is full.',
    ['every_occupied'] = 'All tracks are occupied.',
    ['blip'] = 'Bowling Club'
}