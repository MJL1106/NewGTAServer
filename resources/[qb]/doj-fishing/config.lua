...
Config.FishingWaitTime = {minTime = 15500, maxTime = 25500}     -- How long a player will be waiting to fish, during or after casting fishingrod
...
-- -- Loop through each entry and store only the coords and heading
-- for _, entry in ipairs(dataEntries) do
--     table.insert(Config.GearLocations, {coords = entry.coords, heading = entry.heading})
-- end