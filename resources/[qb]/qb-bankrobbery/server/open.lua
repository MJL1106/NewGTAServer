RegisterNetEvent('qb-bankrobbery:server:callCops', function(type, bank, streetLabel, coords)
    ...
    if type == 'small' then
        ...
        TriggerClientEvent('qb-bankrobbery:client:robberyCallFleeca', -1, type, bank, streetLabel, coords)
    ...
    elseif type == 'paleto' then
        ...
        TriggerClientEvent('qb-bankrobbery:client:robberyCallPaleto', -1, type, bank, streetLabel, coords)
        TriggerClientEvent('qb-phone:client:addPoliceAlert', -1, alertData)
    elseif type == 'pacific' then
        ...
        TriggerClientEvent('qb-bankrobbery:client:robberyCallPacific', -1, type, bank, streetLabel, coords)
        TriggerClientEvent('qb-phone:client:addPoliceAlert', -1, alertData)
    end
    local alertData = {
        title = 'Bank robbery',
