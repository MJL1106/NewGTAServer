...
RegisterNetEvent('qb-bankrobbery:client:robberyCallPacific', function(type, key, streetLabel, coords)
...
function OnGoldHackDonePacific(success)
    if success then
        ...
        TriggerServerEvent('qb-doorlock:server:updateState','PacificVaultDoor', false, false, false, true, false, false)
