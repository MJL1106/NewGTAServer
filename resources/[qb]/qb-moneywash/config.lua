...
CONFIG['Machines'] = {
	...
	{name="Washing Machine", cost="5", perc=1.0, vec=vector3(1136.09, -990.77, 46.11), available=true, finished=false, player=0, worth=0, lastsound=0},
	{name="Washing Machine", cost="5", perc=1.0, vec=vector3(1135.98, -989.56, 46.11), available=true, finished=false, player=0, worth=0, lastsound=0},
	{name="Washing Machine", cost="5", perc=01.0, vec=vector3(1135.74, -988.05, 46.11), available=true, finished=false, player=0, worth=0, lastsound=0},
}