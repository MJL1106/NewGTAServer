CoreConfig = {
    ...
    logout_permission = 'user',

    clothing_base = 'fivem-appearance', -- Whether "qb", "raid", "fivem-appearance" or "other"
    clothing_name = 'illenium-appearance', -- Your clothing resource name
}