...
Config.StressChance = 0.03         -- Default: 3% -- Percentage Stress Chance When Shooting (0-1)
...
Config.MinimumSpeedUnbuckled = 120 -- Going Over This Speed Unbuckled Will Cause Stress
...
Config.Menu = {
    ...
    isChangeFPSChecked = false,          -- isChangeFPSChecked
