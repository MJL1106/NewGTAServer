...
Citizen.CreateThread(function()
    while true do
        ...
        if IsPedInMeleeCombat(myPed) then
            ...
            if (HasPedBeenDamagedByWeapon(myPed, GetHashKey("WEAPON_UNARMED"), 0) ) or (HasPedBeenDamagedByWeapon(myPed, GetHashKey("WEAPON_CROWBAR"), 0) ) or (HasPedBeenDamagedByWeapon(myPed, GetHashKey("WEAPON_WRENCH"), 0) ) then
                -- Health to be knocked out
                if GetEntityHealth(myPed) < 110 then
