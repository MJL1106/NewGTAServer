...
Config.Garages = {
    ...
    ['uwugarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-570.59, -1135.75),
                vector2(-570.43, -1097.75),
                vector2(-585.08, -1096.76),
                vector2(-585.03, -1137.47)
            },
            ['minZ'] = 21,  -- min height of the parking zone
            ['maxZ'] = 24,  -- max height of the parking zone
        },
        label = "Garage",
        showBlip = true,
        blipcoords = vector3(-577.45, -1121.1, 22.38),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                -- public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},                --car, air, sea
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-574.58, -1119.69, 22.18, 270.1),
            vector4(-574.52, -1122.97, 22.18, 269.46),
            vector4(-574.5, -1126.77, 22.18, 272.14),
            vector4(-581.15, -1126.64, 22.18, 94.61),
            vector4(-581.02, -1122.89, 22.18, 93.65),
            vector4(-581.05, -1119.28, 22.18, 90.12),
            vector4(-574.46, -1104.63, 22.18, 266.13),
            vector4(-582.38, -1104.49, 22.18, 89.46),
            vector4(-580.63, -1130.42, 22.18, 85.81),
            vector4(-581.11, -1133.91, 22.18, 93.78),
            vector4(-574.09, -1134.0, 22.18, 267.23),
            vector4(-574.22, -1130.49, 22.18, 269.93),
            vector4(-574.42, -1115.64, 22.18, 269.83),
            vector4(-573.58, -1111.84, 22.18, 266.7),
            vector4(-573.76, -1108.39, 22.18, 276.62),
            vector4(-573.8, -1100.93, 22.18, 271.55),
            vector4(-581.48, -1100.92, 22.18, 87.47),
            vector4(-581.47, -1108.28, 22.18, 91.97),
            vector4(-581.63, -1111.92, 22.18, 93.61),
            vector4(-581.24, -1115.53, 22.18, 89.61),
        }
    },
    -- ['sapcounsel'] = {
    --     ['Zone'] = {
    ...
    ['greatoceonparking'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-3138.59, 1106.62),
                vector2(-3140.51, 1093.32),
                vector2(-3133.69, 1092.24),
                vector2(-3132.16, 1103.99)
            },
            ['minZ'] = 19,  -- min height of the parking zone
            ['maxZ'] = 23,  -- max height of the parking zone
        },
        label = "Garage",
        showBlip = true,
        blipcoords = vector3(-3135.14, 1096.15, 20.59),
        blipName = "Public Parking",
        blipNumber = 357,
        type = 'public',                --public, job, gang, depot
        vehicleCategories = {'car', 'motorcycle', 'other'},
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-3135.19, 1102.43, 20.62, 84.7),
            vector4(-3135.99, 1098.46, 20.62, 88.54),
            vector4(-3136.15, 1094.38, 20.61, 91.62),
        }
    },
    ['impoundlot'] = {
        ['Zone'] = {
    ...
    ['pdgarage'] = {
        ...
        blipNumber = 357,
        type = 'job',
        job = 'police',               --public, job, gang, depot
