...
-- CreateThread(function()
--     local LuckyWheelZone = CircleZone:Create(vector3(990.28, 42.84, 70.52), 2.5, {
--         name="LuckyWheelZone",
--         heading=328.0,
--         debugPoly=false,
--         useZ=true,
...
-- 			exports['qb-target']:AddBoxZone("LuckyWheel", vector3(990.28, 42.84, 70.52), 2.0, {
-- 				name="LuckyWheel",
-- 				heading=160,
-- 				debugPoly=true,
-- 				useZ=true,
...
CreateThread(function() 
	exports['qb-target']:AddBoxZone('WheelSpin1', vector3(990.28, 42.84, 70.52), 1, 1, {
		name = 'WheelSpin1',
		heading = 328.0,  
		debugPoly = false,  
		minZ = 70.9 - 1,  
