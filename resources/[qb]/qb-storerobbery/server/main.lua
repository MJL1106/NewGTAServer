...
local SafeCodes = {}
local cashA = 1050 				--<<how much minimum you can get from a robbery
local cashB = 2050				--<< how much maximum you can get from a robbery
...
RegisterNetEvent('qb-storerobbery:server:takeMoney', function(register, isDone)
    ...
    if isDone then
        ...
        Player.Functions.AddMoney("cash", math.random(cashA, cashB))
