...
RegisterCommand("cancelcarwipe", function(source, args, rawCommand)
  TriggerClientEvent("cancelCarWipe", -1) -- Cancel the wipe on all clients
end, true) -- Assuming you want to restrict who can cancel the car wipe
