...
--------------------------------
local MugShotWebhook = 'https://discord.com/api/webhooks/1179508780233412676/80CPHo0vnSC8LhV5l7ZGWjGDj_NXYswUYUaNFoLRPHgI-CXZVvjvDOgR0Y1mnxfz1JdW'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
local ClockinWebhook = 'https://discord.com/api/webhooks/1179509081774501960/-TtoEMYGCtsNzwXR61nr11tSLSCBUhNCjFKuzk0VsIrgizVQHLOqjb91OXaSLf2BvrC6'

-- Incident and Incident editting. Add a Discord webhook.
-- Incident Author, Title, and Report will display in webhook post.
local IncidentWebhook = 'https://discord.com/api/webhooks/1179508780233412676/80CPHo0vnSC8LhV5l7ZGWjGDj_NXYswUYUaNFoLRPHgI-CXZVvjvDOgR0Y1mnxfz1JdW'
--------------------------------
