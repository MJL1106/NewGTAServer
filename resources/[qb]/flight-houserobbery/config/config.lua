...
Config = {
    ...
    Cooldown = 0, -- (Minutes) This works both for normal robberies and group work robberies (0 = no cooldown)
    GlobalCooldown = {
    ...
    IPLChance = 100, -- Chance of getting an ipl if you are using an NPC and no skill system
