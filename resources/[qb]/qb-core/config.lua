...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 0.8 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 0.65 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = "https://discord.gg/3Pa4ZTNEt3" -- Discord invite link
