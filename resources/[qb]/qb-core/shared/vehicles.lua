...
QBShared.Vehicles = {
    ...
    ['asbo'] = { -- This has to match the spawn code of the vehicle
        ...
        ['price'] = 8000, -- The price that the vehicle sells for
    ...
    ['nkvstr'] = {
        ['name'] = 'unmarked Buffalo',
        ['brand'] = 'unmarked Buffalo',
        ['model'] = 'nkvstr',
        ['price'] = 30000,
        ['category'] = 'police',
        ["categoryLabel"] = 'Police',
    ...
    ['nkjester4um'] = {
        ['name'] = 'Jester Unmarked',
        ['brand'] = 'Jester Unmarked',
        ['model'] = 'nkjester4um',
        ['price'] = 30000,
        ['category'] = 'police',
        ["categoryLabel"] = 'Police',
...
-- --    ['Urus_Stretch_6'] = { <---- NEEDS TO MATCH FILE NAME, MODEL AND HASH NEED TO BE SAME NAME AS THIS, ONLY CHANGE 'NAME' AND 'BRAND' 
--     ['name'] = 'Urus_Stretch_6',
