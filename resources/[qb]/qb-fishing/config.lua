...
Config.oxinv = false -- true if you use ox inv
Config.oxtarget = false -- true if you use ox targer
Config.PoliceChance = 3 -- needs to be 1-99 
...
Config.TreasureChestObject = false -- this will put a chest on the ground people can third eye. if false it will run the event as a usuable item and not put a chest on the ground
