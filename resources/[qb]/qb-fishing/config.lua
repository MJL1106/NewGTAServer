...
Config.Locations = {
    ...
    ['SaltwaterSale'] = { name = "Saltwater Fish Sales", location = vector3(-1589.95, 5194.1, 4.31-0.99), heading = 185.35, blipTrue = true},
}
Config.PedList = {
...
Config.FreshwaterItems = {
    ...
    items = {
	[1] = { name = "water_bottle",  price = 2, amount = 100, info = {}, type = "item", slot = 1, },
	[2] = { name = "sandwich",      price = 2, amount = 250, info = {}, type = "item", slot = 2, },
	[3] = { name = "bandage",       price = 100, amount = 100, info = {}, type = "item", slot = 3, },
	[4] = { name = "redwiggler",    price = 1, amount = 100, info = {}, type = "item", slot = 4, }, 
