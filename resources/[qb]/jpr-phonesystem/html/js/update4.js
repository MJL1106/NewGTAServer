...
$(document).on('click', '.racing-race', function(e){
    ...
    if (!RaceData.RaceData.Started || IsRacer) {
        ...
        sendCustomNotification(Traducoes["184"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
    }
});
...
function SetupRaces(Races) {
    ...
    if (Races.length > 0) {
        ...
        $.each(Races, function(i, race){
            var Locked = '<i class="fas fa-unlock"></i> '+Traducoes["198"]+'';
            if (race.RaceData.Started) {
                Locked = '<i class="fas fa-lock"></i> '+Traducoes["199"]+'';
            }
            var LapLabel = "";
            if (race.Laps == 0) {
                LapLabel = Traducoes["200"]
            } else {
                if (race.Laps == 1) {
                    LapLabel = race.Laps + " "+Traducoes["200"]+"";
                } else {
                    LapLabel = race.Laps + " "+Traducoes["201"]+"";
                }
            }
                ...
                if (InDistance) {
                    $.post('https://jpr-phonesystem/IsBusyCheck', JSON.stringify({
                        ...
                        if (!IsBusy) {
                            ...
                            sendCustomNotification(Traducoes["185"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
                        }
                    });
                }
            })
        } else {
            sendCustomNotification(Traducoes["186"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
        }
    });
});
...
function CheckTrackInfos() {
    ...
    if (value != null && value != undefined && value != "") {
        $.post('https://jpr-phonesystem/GetTrackData', JSON.stringify({
            ...
            $(".racing-setup-information-distance").html(''+Traducoes["203"]+': '+TrackData.Distance+' m');
            $(".racing-setup-information-creator").html(''+Traducoes["204"]+': ' + CreatorTag);
            if (TrackData.Records.Holder !== undefined) {
                ...
                $(".racing-setup-information-wr").html(''+Traducoes["205"]+': ' + secondsTimeSpanToHMS(TrackData.Records.Time) + ' ('+Holder+')');
            } else {
                $(".racing-setup-information-wr").html(''+Traducoes["205"]+': N/A');
            }
...
$(document).on('click', '#setup-race', function(e){
    ...
    $.post('https://jpr-phonesystem/GetRaces', JSON.stringify({}), function(Races){
        ...
        if (Races != undefined && Races != null) {
            var elem = '<option selected>'+Traducoes["198"]+'</option>'; 
            ...
            var elem = '<option selected>'+Traducoes["197"]+'</option>'; 
            $(".dropdown").append(elem);
        }
    });
});
            ...
            if (!data.IsBusy) {
                $.post('https://jpr-phonesystem/IsBusyCheck', JSON.stringify({
                    ...
                    if (!InRace) {
                        ...
                        sendCustomNotification(Traducoes["187"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
                    }
                });
            } else {
                sendCustomNotification(Traducoes["188"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
            }
        } else {
            sendCustomNotification(Traducoes["189"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
        }
    });
});
...
$(document).on('click', '#racing-create-accept', function(e){
    ...
    if (TrackName !== "" && TrackName !== undefined && TrackName !== null) {
        ...
        if (TrackName == '') TrackName = Traducoes["206"]
        $.post('https://jpr-phonesystem/IsAuthorizedToCreateRaces', JSON.stringify({
            ...
            if (data.IsAuthorized) {
                if (data.IsNameAvailable) {
                    ...
                    sendCustomNotification(Traducoes["190"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
                }
            } else {
                sendCustomNotification(Traducoes["191"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
            }
        });
    } else {
        sendCustomNotification(Traducoes["192"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
    }
});
                            ...
                            if (laps !== "") {
                                $.post('https://jpr-phonesystem/CanRaceSetup', JSON.stringify({}), function(CanSetup){
                                    if (CanSetup) {
                                        ...
                                        sendCustomNotification(Traducoes["193"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
                                    }
                                });
                            } else {
                                sendCustomNotification(Traducoes["194"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
                            }
                        } else {
                            sendCustomNotification(Traducoes["195"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
                        }
                    }
                })
            } else {
                sendCustomNotification(Traducoes["196"], "https://r2.fivemanage.com/PztPJI1MS4DPN1q0LBqaP/racing.png", Traducoes["183"])
            }
        });
    }
});
...
$(document).on('click', '.racing-leaderboard-item', function(e){
    ...
    $.each(Data.LastLeaderboard, function(i, leaderboard){
        ...
        var bestroundtime = Traducoes["208"];
        var place = i + 1;
        if (lastname.length > 10) {
            lastname = lastname.substring(0, 10) + "..."
        }
        if (leaderboard.BestLap !== Traducoes["209"]) {
        ...
        if (Races !== null) {
            ...
            $.each(Races, function(i, race){
                if (race.LastLeaderboard.length > 0) {
                    var elem = '<div class="racing-leaderboard-item" id="leaderboard-item-'+i+'"> <span class="racing-leaderboard-item-name"><i class="fas fa-flag-checkered"></i> '+race.RaceName+'</span> <span class="racing-leaderboard-item-info">'+Traducoes["207"]+'</span> </div>'
