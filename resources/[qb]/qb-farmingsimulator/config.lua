...
Config.FruitQuantity = math.random(2, 3) -- How many fruits 1 pick give to player

Config.MilkQuantity = math.random(2, 3) -- How many milk 1 cow give to player
...
-- Sell Prices
Config.TomatoJuicePrice = math.random(70, 90)
Config.FlourPrice = math.random(70, 90)
Config.PotatoPrice = math.random(70, 90)
Config.CucumberPrice = math.random(70, 90)
Config.OnionPrice = math.random(70, 90)
Config.CabbagePrice = math.random(70, 90)
Config.LettucePrice = math.random(70, 90)
Config.CarrotPrice = math.random(70, 90)
Config.BeetPrice = math.random(70, 90)
Config.TurnipPrice = math.random(70, 90)
Config.MushroomsPrice = math.random(70, 90)
Config.MilkPrice = math.random(18, 28)
Config.OrangePrice = math.random(7, 10)
Config.PeachPrice = math.random(7, 10)
Config.PearPrice = math.random(7, 10)
Config.ApplePrice = math.random(7, 10)
Config.MangoPrice = math.random(7, 10)
Config.LemonPrice = math.random(7, 10)
