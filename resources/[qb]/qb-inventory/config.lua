...
Config.CleanupDropTime = 8 * 60 -- How many seconds it takes for drops to be untouched before being deleted
Config.MaxDropViewDistance = 8 -- The distance in GTA Units that a drop can be seen
