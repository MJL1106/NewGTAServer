...
supportedVehicles = {
    ...
    { name = "Jester RR", model = "jester4", class = "A" },
    ...
    { name = "6STR Schwartzer", model = "schwarzer2", class = "A" },
    { name = "6STR Sentinel Classic", model = "sentinel6str2", class = "A" },
    { name = "6STR ZR380", model = "zr3806str", class = "A" },
    ...
    { name = "Grotti Cheetah Classic", model = "cheetah2", class = "A" },
    { name = "Pegassi Infernus Classic", model = "infernus2", class = "A" },
    { name = "Pegassi Torero", model = "torero", class = "A" },
    ...
    { name = "Grotti Furia", model = "furia", class = "A" },
    { name = "Coquette D10", model = "coquette4", class = "A" },
    ...
    { name = "6STR Ellie", model = "ellie6str", class = "A" },
    { name = "6STR Gauntlet", model = "gauntlet6str", class = "A" },
    { name = "6STR Ladybird", model = "ladybird6str", class = "A" },
    { name = "Bravado Gauntlet Classic", model = "gauntlet3", class = "A" },
    ...
    { name = "Beater Dukes", model = "dukes3", class = "A" },
    ...
    { name = "Grotti Itali RSX", model = "italirsx", class = "A" },
