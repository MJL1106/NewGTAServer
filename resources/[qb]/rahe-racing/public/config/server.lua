svConfig = {
    ...
    maximumGeneratedCompetitions = 2,
    ...
    minimumParticipantsForRaceTab = 0,
    ...
    isCompetitionCreationRestricted = true,
    ...
    competitionCreationRequiredElo = 0,
    ...
    -- Identifier string values should be taken from ra_racing_user_settings.player_identifier.
    competitionRestrictionIdentifiers = { 'DMZ67014','2' },
