...
Config.Helicopter = "emsheli" -- Helicopter model that players with the ambulance job can use
...
Config.ForceInjury = 75 -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
Config.AlwaysBleedChance = 30 -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
...
Config.BleedTickRate = 150 -- How much time, in seconds, between bleed ticks
Config.BleedMovementTick = 1 -- How many seconds is taken away from the bleed tick rate if the player is walking, jogging, or sprinting
Config.BleedMovementAdvance = 1 -- How much time moving while bleeding adds
...
Config.BlackoutTimer = 20 -- How many bleed ticks occur before blacking out
Config.AdvanceBleedTimer = 10 -- How many bleed ticks occur before bleed level increases
Config.HeadInjuryTimer = 90 -- How much time, in seconds, do head injury effects chance occur
Config.ArmInjuryTimer = 90 -- How much time, in seconds, do arm injury effects chance occur
Config.LegInjuryTimer = 150 -- How much time, in seconds, do leg injury effects chance occur
Config.HeadInjuryChance = 15 -- The chance, in percent, that head injury side-effects get applied
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["main"] = {
        [1] = vector3(327.34, -603.86, 43.28),
    },
    ["garage"] = {
        [1] = vector3(339.42, -584.6, 28.8),
    },
    ["main2"] = {
        [1] = vector3(332.3, -595.8, 43.28),
    },
    ["stash"] = {
        [1] = vector3(298.61, -598.29, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(307.79, -581.66, 42.0, 335.88), taken = false, model = 1631638868},
        [2] = {coords = vector4(311.12, -582.81, 42.0, 324.68), taken = false, model = 1631638868},
        [3] = {coords = vector4(314.59, -584.04, 42.0, 334.3), taken = false, model = 1631638868},
        [4] = {coords = vector4(317.8, -585.5, 42.0, 331.32), taken = false, model = 1631638868},
        [5] = {coords = vector4(322.62, -587.17, 42.0, 337.26), taken = false, model = 1631638868},
        [6] = {coords = vector4(324.09, -583.04, 42.0, 148.09), taken = false, model = 1631638868},
        [7] = {coords = vector4(319.18, -581.21, 42.0, 152.84), taken = false, model = 1631638868},
        [8] = {coords = vector4(313.79, -579.35, 42.0, 149.16), taken = false, model = 1631638868},
        [9] = {coords = vector4(309.26, -577.25, 42.0, 157.11), taken = false, model = 1631638868},
	--- paleto
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
	...
	[0] = {
		["ambulance"] = "Ambulance",
        ["chargfire"] = "EMS Charger",
        ["sprinter1"] = "Sprinter 1",
        ["sprinter2"] = "Sprinter 2",
        ["fd2020m"] = "Medic Suv",
        ["emsnspeedo"] = "Ambulance 2",
        ["1200rtems"] = "EMS Bike",
	},
	-- Grade 1
	[1] = {
