...
local cashA = 2000 				--<<how much minimum you can get from a robbery
local cashB = 3050				--<< how much maximum you can get from a robbery
local ActivationCost = 100		--<< how much is the activation of the mission (clean from the bank)
...
RegisterServerEvent('AttackTransport:graczZrobilnapad', function()
	...
	xPlayer.Functions.AddMoney("cash", math.random(cashA, cashB))
