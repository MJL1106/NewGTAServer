svConfig = {
    ...
    initialContractAmount = 2,

    -- The amount of online police required for people to get important (B / A / S class) contracts. This will be applied to classes which have the 'isImportant' as true.
    ...
    storeItems = {
        ['nightvision'] = {
            ...
            description = "Realy nice for when its dark.",
            iconFile = 'nightvision.png',
            receiveItemIds = {
                [1] = 'nightvision',
            }
        },
        ['greenphone'] = {
            cashRequired = 3000,
            cryptoRequired = 500,
            availablePerRestart = 1,
            isSoldOut = false,
            title = "Green Satellite Phone",
            description = "A communication device used to contact russian mafia.",
            iconFile = 'greenphone.png',
            receiveItemIds = {
                [1] = 'greenphone',
            }
        },
