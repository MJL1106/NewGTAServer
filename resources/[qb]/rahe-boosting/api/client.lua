...
CreateThread(function()
    exports["qb-target"]:AddBoxZone("BoostTablet", vector3(-1361.64, -758.64, 22.5), 1.65, 2.4, {
        name = "BoostTablet",
        heading = 312.54,
        debugPoly = false,
        minZ = 22,
        ...
        options = {
            {
                type = "client",
                event = "rahe-boosting:BuyBoostingTablet",
                icon = "fas fa-tablet",
                label = 'Buy Device ($10,000)',
...
--Buy boosting tablet
RegisterNetEvent("rahe-boosting:BuyBoostingTablet", function()
    TriggerServerEvent('rahe-boosting:server:BuyTablet')
end)
