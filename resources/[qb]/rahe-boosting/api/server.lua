...
RegisterServerEvent('rahe-boosting:server:BuyTablet', function()
    local Player = QBCore.Functions.GetPlayer(source)
    local item = 'boostingtablet'
    ...
    if Player.PlayerData.money.cash >= 10000 then
        ...
        TriggerClientEvent('QBCore:Notify', source, 'You purchased a Boosting Tablet for $10,000 cash', 'success', 3000)
    else
