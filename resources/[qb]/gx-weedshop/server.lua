...
RegisterNetEvent('gx-weedshop:server:HarvestAmnesiaSeed', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local trimmingscissors = Player.Functions.GetItemByName('trimming_scissors')
    ...
    if trimmingscissors ~= nil then
        ...
        Player.Functions.AddItem('weed_amnesia_seed', 2)
...
RegisterNetEvent('gx-weedshop:server:HarvestWhiteWidowSeed', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local trimmingscissors = Player.Functions.GetItemByName('trimming_scissors')
    ...
    if trimmingscissors ~= nil then
        ...
        Player.Functions.AddItem('weed_white-widow_seed', 2)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["weed_white-widow_seed"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
...
RegisterNetEvent('gx-weedshop:server:BagAk47', function()
    ...
    if ak47bud ~= nil and emptyweedbag ~= nil then
        ...
        Player.Functions.AddItem('weed_ak47_ww', 5)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["weed_ak47_ww"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
...
RegisterNetEvent('gx-weedshop:server:BagAmnesia', function()
    ...
    if amnesiabud ~= nil and emptyweedbag ~= nil then
        ...
        Player.Functions.AddItem('weed_amensia_ww', 5)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["weed_amensia_ww"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
...
RegisterNetEvent('gx-weedshop:server:BagOgKush', function()
    ...
    if ogkushbud ~= nil and emptyweedbag ~= nil then
        ...
        Player.Functions.AddItem('weed_og-kush_ww', 5)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["weed_og-kush_ww"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
...
RegisterNetEvent('gx-weedshop:server:BagPurpleHaze', function()
    ...
    if purplehazebud ~= nil and emptyweedbag ~= nil then
        ...
        Player.Functions.AddItem('weed_purple-haze_ww', 5)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["weed_purple-haze_ww"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
...
RegisterNetEvent('gx-weedshop:server:BagSkunk', function()
    ...
    if skunkbud ~= nil and emptyweedbag ~= nil then
        ...
        Player.Functions.AddItem('weed_skunk_ww', 5)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["weed_skunk_ww"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
...
RegisterNetEvent('gx-weedshop:server:BagWhiteWidow', function()
    ...
    if whitewidowbud ~= nil and emptyweedbag ~= nil then
        ...
        Player.Functions.AddItem('weed_white-widow_ww', 5)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["weed_white-widow_ww"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
...
RegisterNetEvent('gx-weedshop:server:RollAk47', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local weedak47 = Player.Functions.GetItemByName('weed_ak47_ww')
    ...
    if weedak47 ~= nil and rollingpaper ~= nil then
        ...
        Player.Functions.RemoveItem('weed_ak47_ww', 5)
...
RegisterNetEvent('gx-weedshop:server:RollAmnesia', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local weedamnesia = Player.Functions.GetItemByName('weed_amnesia_ww')
    local rollingpaper = Player.Functions.GetItemByName('rolling_paper')

    if weedamnesia ~= nil and rollingpaper ~= nil then

        Player.Functions.RemoveItem('rolling_paper', 5)
        Player.Functions.RemoveItem('weed_amnesia_ww', 5)
...
RegisterNetEvent('gx-weedshop:server:RollOgKush', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local weedogkush = Player.Functions.GetItemByName('weed_og-kush_ww')
    local rollingpaper = Player.Functions.GetItemByName('rolling_paper')

    if weedogkush ~= nil and rollingpaper ~= nil then

        Player.Functions.RemoveItem('rolling_paper', 5)
        Player.Functions.RemoveItem('weed_og-kush_ww', 5)
...
RegisterNetEvent('gx-weedshop:server:RollPurpleHaze', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local weedphaze = Player.Functions.GetItemByName('weed_purple-haze_ww')
    local rollingpaper = Player.Functions.GetItemByName('rolling_paper')

    if weedphaze ~= nil and rollingpaper ~= nil then

        Player.Functions.RemoveItem('rolling_paper', 5)
        Player.Functions.RemoveItem('weed_purple-haze_ww', 5)
...
RegisterNetEvent('gx-weedshop:server:RollSkunk', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local weedskunk = Player.Functions.GetItemByName('weed_skunk_ww')
    local rollingpaper = Player.Functions.GetItemByName('rolling_paper')

    if weedskunk ~= nil and rollingpaper ~= nil then
        
        Player.Functions.RemoveItem('rolling_paper', 5)
        Player.Functions.RemoveItem('weed_skunk_ww', 5)
...
RegisterNetEvent('gx-weedshop:server:RollWhiteWidow', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local weedww = Player.Functions.GetItemByName('weed_white-widow_ww')
    local rollingpaper = Player.Functions.GetItemByName('rolling_paper')

    if weedww ~= nil and rollingpaper ~= nil then

        Player.Functions.RemoveItem('rolling_paper', 5)
        Player.Functions.RemoveItem('weed_white-widow_ww', 5)
...
RegisterNetEvent('gx-weedshop:server:RollThickPaper', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    local rollingpaper = Player.Functions.GetItemByName('rolling_paper')

    if rollingpaper ~= nil then

        Player.Functions.RemoveItem('rolling_paper', 2)
        Player.Functions.AddItem('rolling_paper_thick', 1)
        TriggerClientEvent('inventory:client:ItemBox', source, QBCore.Shared.Items["rolling_paper_thick"], "add")
    else
        TriggerClientEvent('QBCore:Notify', src, 'You do not have the right items...', 'error')
    end
end)
