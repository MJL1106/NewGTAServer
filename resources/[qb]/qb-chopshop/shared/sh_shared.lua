...
Shared.Phone = 'jpr-phone' -- 'QBCore' or 'GKS' or 'Qs' or 'lb-phone' or edit utils files for others
...
Shared.Time = 0.0 -- Minutes it takes to get a job upon interacting with the ped.
...
Shared.AutoRestartDelay = 0.5 -- Minutes it takes to get a new job after completing one
Shared.FuelAmount = 80.0

-- Zone Sizes
Shared.VehicleZoneRadius = 75.0
Shared.VehicleBlipRadius = 125.0
Shared.VehicleBlipOffset = 100.0
