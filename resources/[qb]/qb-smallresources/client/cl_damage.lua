CreateThread(function()
	...
	SetWeaponDamageModifier(`WEAPON_KATANA`, 2.5) -- Katana
	...
	SetWeaponDamageModifier(`WEAPON_BATTLEAXE`, 0.7)
	SetWeaponDamageModifier(`WEAPON_STONE_HATCHET`, 0.7)
	-- Pistol (Blacklisted)
	...
	SetWeaponDamageModifier(`WEAPON_CERAMICPISTOL`, 1.0)
	...
	SetWeaponDamageModifier(`WEAPON_ASSAULTSMG`, 0.7) 
	...
	SetWeaponDamageModifier(`WEAPON_SAWNOFFSHOTGUN`, 1.1) 
	...
	SetWeaponDamageModifier(`WEAPON_HEAVYSNIPER`, 2.5) 
	SetWeaponDamageModifier(`WEAPON_HEAVYSNIPER_MK2`, 2.5)
	SetWeaponDamageModifier(`WEAPON_MARKSMANRIFLE`, 2.5)
	SetWeaponDamageModifier(`WEAPON_MARKSMANRIFLE_MK2`, 2.5)
