...
Config.AFK = {
    ...
    secondsUntilKick = 8600 -- AFK Kick Time Limit (in seconds)
}
...
Config.MapText = "~y~BanglaPixel" -- This is the name / text shown above the map
...
Config.Objects = { -- for object removal
    ...
    {coords = vector3(206.53, -803.48, 30.95), heading = 0, length = 200, width = 200, model = "prop_sec_barrier_ld_01a"},
    {coords = vector3(230.92, -816.15, 30.17), heading = 0, length = 200, width = 200, model = "prop_sec_barrier_ld_01a"},
