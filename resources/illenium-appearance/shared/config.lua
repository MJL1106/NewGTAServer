...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(-1203.64, -1455.28, 4.37, 37.48),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1202.85, -1454.96, 4.36),
            vector3(-1203.96, -1455.71, 4.36),
            vector3(-1204.43, -1455.07, 4.38),
            vector3(-1203.45, -1454.34, 4.38)
        }
    },
    ...
    {
        type = "surgeon",
        coords = vector4(314.64, -568.89, 43.28, 155.38),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(314.64, -568.89, 43.28),
            vector3(312.64, -565.89, 43.28),
            vector3(309.64, -568.89, 43.28),
            vector3(312.64, -566.89, 43.28)
        }
    }
}
...
Config.ClothingRooms = {
    ...
    -- {
    --     job = "ambulance",
    --     coords = vector4(301.27, -599.52, 43.28, 244.8),
    --     size = vector3(4, 4, 4),
    --     rotation = 45,
    --     usePoly = false,
    --     points = {
    --         vector3(301.27, -599.52, 43.28),
    --         vector3(301.43, -595.89, 43.28),
    --     }
    -- },
}
