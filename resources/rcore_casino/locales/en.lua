Translation["en"] = {
    ...
    WHEEL_PRESS_TO_SPIN = "Press E to start spinning the wheel, or press ~INPUT_CELLPHONE_CANCEL~ to leave.",
    ...
    CAPT_ERROR = "Error",
    BTN_CLOSE = "Close",
    GAME_STATE_DISABLED = "This activity is temporarily disabled.",
