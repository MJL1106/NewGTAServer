Config = {
    ...
    ExchangeRate = 0.7, -- set value of one casino chip, for example, set to 5, if 1 chip equals to 5$ (minimum: 0.1, rounded by 0.1, 0.5 or 1)
    ...
    LUCKY_WHEEL_FREE_DRINKS_FOR = (60 * 60 * 0.01), -- when someone spins "Free Drinks" at the Lucky Wheel, how long they get free drinks for. def: 24 hours (60 * 60 * 24)
    ...
    CASHIER_VIP_PRICE = 250000, -- price of the VIP casino membership, def: 50000
    CASHIER_VIP_DURATION = (60 * 60 * 24) * 30, -- VIP for player resets after this time, def: 7 days
    ...
    'qb-banking': using qb-banking 2.0 export functions
