...
function OnEnterCasino()
    ...
    if Config.MapType == 8 then
        CreateModelSwap(1090.047485, -2315.047607, 23.453121, 100.0, GetHashKey("h4_prop_casino_3cardpoker_01a"),
            GetHashKey("vw_prop_casino_3cardpoker_01b"))
        CreateModelSwap(1090.047485, -2315.047607, 23.453121, 100.0, GetHashKey("h4_prop_casino_3cardpoker_01b"),
            GetHashKey("vw_prop_casino_3cardpoker_01b"))
        CreateModelSwap(1090.047485, -2315.047607, 23.453121, 100.0, GetHashKey("h4_prop_casino_3cardpoker_01c"),
            GetHashKey("vw_prop_casino_3cardpoker_01b"))
        CreateModelSwap(1090.047485, -2315.047607, 23.453121, 100.0, GetHashKey("h4_prop_casino_3cardpoker_01d"),
            GetHashKey("vw_prop_casino_3cardpoker_01b"))
        CreateModelSwap(1090.047485, -2315.047607, 23.453121, 100.0, GetHashKey("h4_prop_casino_3cardpoker_01e"),
            GetHashKey("vw_prop_casino_3cardpoker_01b"))
    end
...
AddEventHandler("Casino:InitialInfo", function(states, isAdmin, id, isOpen, nextOpenTime, forceClosed)
    GameStates = states
    PLAYER_IS_ADMIN = isAdmin
    MY_PLAYERID = id
...
RegisterNetEvent("Casino:CasinoOpenStateChanged")
AddEventHandler("Casino:CasinoOpenStateChanged", function(isOpen, nextOpenTime, forceClosed)
    CasinoOpenStateChanged(isOpen, nextOpenTime, forceClosed)
end)
