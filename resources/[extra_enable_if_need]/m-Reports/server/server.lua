    ...
    embed = {
        {
            ...
            ["title"] = "**NEW REPORT**",
            ["description"] = "" .. message ..  "",
            ["footer"] = { ["text"] = '[MSRP-Reports] | Created By OtakuSensei', },
        }
    }
    PerformHttpRequest(Webhook, 
    function(err, text, headers) end, 'POST', json.encode({username = '[msrp-Reports] - Logs', embeds = embed}), { ['Content-Type'] = 'application/json' })
end
