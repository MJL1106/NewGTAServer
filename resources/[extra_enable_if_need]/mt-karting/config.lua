Config = {
    ...
    ['Locations'] = {
        ...
        ['KartSpawn'] = vector4(-161.46, -2137.78, 16.71, 295.39),
    },
    ['Tickets'] = {
        [1] = {
            time = 5,
    ...
    ['Lang'] = {
        ['MenuHeader'] = 'Kart Menu',
        ['CloseMenu'] = 'Close Menu',
        ['Ticket1'] = 'Silver Ticket',
        ['Ticket2'] = 'Bronze Ticket',
        ['Ticket3'] = 'Gold Ticket',
        ['Ticket4'] = 'Premium Ticket',
        ['Duration'] = 'Duration: ',
        ['Minutes'] = ' minutes',
        ['Price'] = 'Price ',
        ...
        ['TicketCancelled'] = 'You have cancelled your ticket. No refunds...',
